...
# TODO: Take the string "movies_str" and convert it into a list and 
#assign it to a variable called "remaining_50_list"
# Note: Print your new variable to see the list of movies
remaining_50_list = movies_str.split(',')
print(remaining_50_list)

# TODO: Hmm. Looks like "remaining_50_list" contains the movie 
#"The Matrix" which is also in the "top_50_list". Let's remove this
# duplicate title from "remaining_50_list".
# Note: Make sure to double check the list you are removing from!
print()
remaining_50_list.remove('The Matrix')
print(remaining_50_list)
# TODO: We're down to 49 movies in "remaining_50_list". 
#Let's add a movie to the list called "Anywhere But Here"
...
#Uncomment the line of code below and run your code to see how it's done!
...
# TODO: Let's print the first movie in our "top_100" list.
# Let's use the index lookup method to do this.

print(top_100[0])

print()

# TODO: Let's print the top 10 movies in "top_100" as a list. 
#Let's use the slice syntax to accomplish this!
print(top_100[0:10])


print()

# TODO: Let's convert the list "top_100" back into a string. 
#Assign it to a variable called "top_100_str".
